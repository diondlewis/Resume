...
var bio = {
	...
	"skills": ["Computer Networking", "HTML", "CSS", "Javascript", "Python", "Adobe Photoshop", "Adobe Illustrator", "Logo Design"],
...
var work = {
	"jobs": [
		...
		{	
			...
			"description": "Wrote several computer programs and scripts that helped coordinate services for children with disabilites."
		},
		{	
			...
			"description": "Designed the layout of the newspaper and all advertisements inside. Also designed Chicago's first parking garage map."
		}
	]
}
	...
	"projects": [
		{
			...
			"dates": 2012,
			"description":"At AT&T, I was asked to create this logo to help inspire excitement for AT&T's new saftey initiative.", //remember to add comma
			"images": ["images/safety.jpg"]
		},
		{	
			"title": "Lady Hurricanes Basketball Team Jersey Design",
			"dates": 2011,
			"description":"I designed the logo and jersey design for this girls basketball team. Go Hurricanes!", //remember to add comma
...
// this function takes in info from the work object and returns an array of the locations
// I've worked at 
